...
public class NoticeController {
    ...
    private final IBoardService noticeService;
...
/**
    ...
    public String noticeList(HttpSession session, ModelMap model)
        ...
        log.info("세션에 저장되있는 사용자 닉네임: " +ssUserId);

        // 공지사항 리스트 조회하기
        // Java 8부터 제공되는 Optional 활용하여 NPE(Null Pointer Exception) 처리
        List<BoardDTO> rList = Optional.ofNullable(noticeService.getNoticeList())
...
/*
            ...
            BoardDTO pDTO = BoardDTO.builder().userId(userId).title(title)
...
/*
        ...
        BoardDTO pDTO = BoardDTO.builder().noticeSeq(Long.parseLong(nSeq)).build();

        // 공지사항 상세정보 가져오기
        // Java 8부터 제공되는 Optional 활용하여 NPE(Null Pointer Exception) 처리
        BoardDTO rDTO = Optional.ofNullable(noticeService.getNoticeInfo(pDTO, true))
...
/*
        ...
        // Java 8부터 제공되는 Optional 활용하여 NPE(Null Pointer Exception) 처리
        BoardDTO rDTO = Optional.ofNullable(noticeService.getNoticeInfo(pDTO, false))
                .orElseGet(() -> BoardDTO.builder().build());
...
/*
            ...
            BoardDTO pDTO = BoardDTO.builder().userId(userId).noticeSeq(Long.parseLong(nSeq))
